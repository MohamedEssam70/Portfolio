...
(function() {
  ...
  //All Info API
  fetch("https://portfolio.alalfy.com/api/info")
  .then((response) => response.json())
  .then((data) => {
    // Hero Name
    document.getElementById('myName').textContent = 'I am ' + data.name;
    // Jobs
    document.getElementById('jobs').setAttribute('data-typed-items', data.job);
    ...
    /* Counters */
    document.getElementById('projects-count').setAttribute('data-purecounter-end', data.projects_count);
    document.getElementById('clients-count').setAttribute('data-purecounter-end', data.clients_count);
    document.getElementById('years-count').setAttribute('data-purecounter-end', data.years_of_experience);
    // setTimeout(()=>{
    // /**
